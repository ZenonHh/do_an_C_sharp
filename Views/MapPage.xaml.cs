...
public partial class MapPage : ContentPage
{
    ...
    private Mapsui.Map CreateMap()
    {
        ...
        map.Home = n => n.CenterOnAndZoomTo(new MPoint(center.x, center.y), 2);
        return map;
    }
    ...
    private async void OnLanguageClicked(object sender, EventArgs e)
    {
        ...
        // Logic đổi ngôn ngữ sẽ xử lý ở đây sau
    }
    ...
    {
        if (_isPlaying) _ttsCancellationTokenSource?.Cancel(); 
