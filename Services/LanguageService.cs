    ...
    {
        {
            "vi", new Dictionary<string, string>
            {
                ...
                { "payment_title", "Thanh Toán & Lượt Nghe" },
                { "scans_remaining", "Lượt nghe còn lại" },
                { "scans_unit", "lượt" },
                { "choose_package", "Chọn gói nạp lượt:" },
                { "buy_btn", "Mua" },
                { "processing_payment", "Đang xử lý thanh toán..." },
                { "pkg_basic_name", "Gói Cơ Bản" },
                { "pkg_basic_desc", "+5 lượt nghe" },
                { "pkg_premium_name", "Gói Cao Cấp" },
                { "pkg_premium_desc", "+20 lượt nghe" },
                { "pkg_vip_name", "Gói VIP" },
                { "pkg_vip_desc", "Không giới hạn lượt nghe" },
                { "popular_badge", "🔥 PHỔ BIẾN" },
                { "payment_menu", "Thanh toán & Lượt nghe" }
            }
        },
        {
            "en", new Dictionary<string, string>
            {
                ...
                { "payment_title", "Payment & Listens" },
                { "scans_remaining", "Listens remaining" },
                { "scans_unit", "listens" },
                { "choose_package", "Select a package:" },
                { "buy_btn", "Buy" },
                { "processing_payment", "Processing payment..." },
                { "pkg_basic_name", "Basic Package" },
                { "pkg_basic_desc", "+5 listens" },
                { "pkg_premium_name", "Premium Package" },
                { "pkg_premium_desc", "+20 listens" },
                { "pkg_vip_name", "VIP Package" },
                { "pkg_vip_desc", "Unlimited listens" },
                { "popular_badge", "🔥 POPULAR" },
                { "payment_menu", "Payment & Listens" },
        ...
        },
        {
            "ja", new Dictionary<string, string>
            {
                ...
                { "payment_title", "支払い & 再生回数" },
                { "scans_remaining", "残り再生回数" },
                { "scans_unit", "回" },
                { "choose_package", "パッケージを選択:" },
                { "buy_btn", "購入" },
                { "processing_payment", "支払い処理中..." },
                { "pkg_basic_name", "ベーシック" },
                { "pkg_basic_desc", "+5 回再生" },
                { "pkg_premium_name", "プレミアム" },
                { "pkg_premium_desc", "+20 回再生" },
                { "pkg_vip_name", "VIP" },
                { "pkg_vip_desc", "無制限再生" },
                { "popular_badge", "🔥 人気" },
                { "payment_menu", "支払い & 再生回数" },
                { "all", "すべて" },
                { "direction", "道順" },
