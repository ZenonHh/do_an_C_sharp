...
public class LocationService : ILocationService
{
    ...
    public LocationService()
    {
        ...
        {
            System.Diagnostics.Debug.WriteLine($"ERROR initializing LocationService: {ex}");
            _request = new GeolocationRequest(GeolocationAccuracy.Default, TimeSpan.FromSeconds(5));
        }
    }
